...
public class Sponsor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Add A Sponsor Information");
        ...
        jLabel7.setText("To Remove a Sponsor Insert the Sponsor ID");
        ...
        jButton3.setText("Show All Sponsors Details");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            Connection c=CD.makeConnection();
            Statement s=c.createStatement();
            
            int n=Integer.parseInt(jTextField4.getText());
            String q="Select Name from sponsor where SponsorID="+n+"";
            ResultSet rs;
            rs=s.executeQuery(q);
            rs.next();
            String nm=rs.getString("Name");
            String query="Delete from sponsor where SponsorID="+n+"";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            String q1="Select MAX(SponsorID) from sponsor";
            ResultSet r;
            r=st.executeQuery(q1);
            r.next();
            int v_id=r.getInt("MAX(SponsorID)");
            if (v_id!=0){
                sr_Id=v_id+1;
            }
            String q2="Select CampID from camp_info where SponsorName='"+name+"'";
            r=st.executeQuery(q2);
            r.next();
            int campid=r.getInt("CampID");
            
            String query="insert into sponsor (CampID,SponsorID,Name,Contact,`Amount (in taka)`) values ('"+campid+"','"+sr_Id+"','"+name+"','"+contact+"','"+amount+"')";
            st.executeUpdate(query);
            JOptionPane.showMessageDialog(null, "Insertion Completed");
        }
        catch (Exception e) {
          JOptionPane.showMessageDialog(null, "Sponsor Name does not match");  
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            Sponsor_Details newFrame =  new Sponsor_Details(rs);
            this.dispose();
